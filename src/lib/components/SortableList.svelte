<script lang="ts">
  ...
  // calculates the start and end position of an element
  // to animate between them

  // createEventDispatcher allows to send a custom event
  // like when the items have been re-sorted
  ...
  // recursive function, that determines the actual html element being dragged
