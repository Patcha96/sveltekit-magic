...
<main class="max-w-lg prose text-center mx-auto my-6">
  ...
  <!-- use:enhance reloads the data that was changed on 
  the client side using js rather than reloading the whole page -->
  <form action="" method="post" use:enhance>
    <div class="form-control">
      <label for="bio" class="label"
        ><span class="label-text">Your bio</span></label
      >
      <textarea
        name="bio"
        class="textarea text-area-bordered textarea-accent"
        value={data.bio}
      />
    </div>
